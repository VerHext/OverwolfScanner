...
public class TSListener implements TS3Listener { 
	...
	public void updateOverwolf(int id, int idd){
     ...
     //OVERWOLF
			...
			{
				if (Sid.getId() == cfg.getInt(Config.ServerGroup)){
					api.removeClientFromServerGroup(cfg.getInt(Config.ServerGroup), id);
	...
	//NO OVERWOLF
			...
			if (setOverwolf)
			{
				...
				api.addClientToServerGroup(cfg.getInt(Config.ServerGroup), id);
			}
